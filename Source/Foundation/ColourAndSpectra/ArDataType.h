...
typedef enum ArDataType
{
    ...
    ardt_ut_rgb                 = C_3   | B_192  | DBL | RGB  | UT,
    ardt_ut_rgb_polarisable     = C_3   | B_192  | DBL | RGB  | UT | POL,
    ardt_frgb                   = C_3   | B_96   | FLT | RGB,
    ardt_rgb                    = C_3   | B_192  | DBL | RGB,
    ardt_ut_rgba                = C_4   | B_256  | DBL | RGBA | UT,
    ardt_ut_rgba_polarisable    = C_4   | B_256  | DBL | RGBA | UT | POL,
    ardt_frgba                  = C_4   | B_128  | FLT | RGBA,
    ardt_rgba                   = C_4   | B_256  | DBL | RGBA,

    ardt_ut_xyz                 = C_3   | B_192  | DBL | XYZ  | UT,
    ardt_ut_xyz_polarisable     = C_3   | NOINFO | DBL | XYZ  | UT | POL,
    ardt_fciexyz                = C_3   | B_128  | FLT | XYZ,
    ardt_ciexyz                 = C_3   | B_192  | DBL | XYZ,
    ardt_ut_xyza                = C_4   | B_256  | DBL | XYZA | UT,
    ardt_ut_xyza_polarisable    = C_4   | NOINFO | DBL | XYZA | UT | POL,
    ardt_fciexyza               = C_4   | B_128  | FLT | XYZA,
    ardt_ciexyza                = C_4   | B_256  | DBL | XYZA,
