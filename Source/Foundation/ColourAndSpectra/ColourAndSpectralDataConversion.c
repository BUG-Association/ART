        ...
        )
{
    ...
    ARRGB_S(*cr) = ARGREY_S(*c0);
    CC_OPERAND_DEBUGPRINTF( rgb, cr )
    CC_END_DEBUGPRINTF( g_to_rgb )
}

COLOUR_CONVERSION_BY_MACRO(GREY,Grey,g,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(GREY,Grey,g,UTF_RGB,UTF_RGB,utf_rgb)
        ...
        )
{
    ...
    ARRGBA_A(*cr) = 1.0;
    ARRGBA_S(*cr) = ARGREY_S(*c0);
    CC_END_DEBUGPRINTF( g_to_rgba )
}

COLOUR_CONVERSION_BY_MACRO(GREY,Grey,g,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(GREY,Grey,g,UTF_RGBA,UTF_RGBA,utf_rgba)
        ...
        )
{
    ...
    ARRGB_S(*cr) = ARGREYALPHA_S(*c0);
    CC_OPERAND_DEBUGPRINTF( rgb, cr )
    CC_END_DEBUGPRINTF( g_to_rgb )
}

COLOUR_CONVERSION_BY_MACRO(GREYALPHA,GreyAlpha,ga,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(GREYALPHA,GreyAlpha,ga,UTF_RGB,UTF_RGB,utf_rgb)
        ...
        )
{
    ...
    ARRGBA_S(*cr) = ARGREYALPHA_S(*c0);
    CC_END_DEBUGPRINTF( g_to_rgba )
}

COLOUR_CONVERSION_BY_MACRO(GREYALPHA,GreyAlpha,ga,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(GREYALPHA,GreyAlpha,ga,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_BY_MACRO(GREY8,Grey8,g8,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(GREY8,Grey8,g8,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_VIA_GREY(Grey8,g8,RGBA,rgba)

COLOUR_CONVERSION_BY_MACRO(GREY8,Grey8,g8,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(GREY8,Grey8,g8,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_BY_MACRO(GREY16,Grey16,g16,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(GREY16,Grey16,g16,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_VIA_GREY(Grey16,g16,RGBA,rgba)

COLOUR_CONVERSION_BY_MACRO(GREY16,Grey16,g16,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(GREY16,Grey16,g16,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_BY_MACRO(GREYALPHA16,GreyAlpha16,ga16,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(GREYALPHA16,GreyAlpha16,ga16,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_VIA_GREY(GreyAlpha16,ga16,RGBA,rgba)

COLOUR_CONVERSION_BY_MACRO(GREYALPHA16,GreyAlpha16,ga16,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(GREYALPHA16,GreyAlpha16,ga16,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_BY_MACRO(GREYALPHA32,GreyAlpha32,ga32,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(GREYALPHA32,GreyAlpha32,ga32,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_VIA_GREY(GreyAlpha32,ga32,RGBA,rgba)

COLOUR_CONVERSION_BY_MACRO(GREYALPHA32,GreyAlpha32,ga32,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(GREYALPHA32,GreyAlpha32,ga32,UTF_RGBA,UTF_RGBA,utf_rgba)
        ...
        )
{
    ...
    ARRGB_S(*rgb) = DEFAULT_RGB_SPACE_REF;

    //printf(C3_M_FORMAT("%6.5f") "\n",C3_M_PRINTF(ARCSR_XYZ_TO_RGB( DEFAULT_RGB_SPACE_REF )));fflush(stdout);
...
COLOUR_CONVERSION_VIA_RGB(CIEXYZ,xyz,UT_RGB,ut_rgb)
COLOUR_CONVERSION_VIA_RGB(CIEXYZ,xyz,UTF_RGB,utf_rgb)
...
COLOUR_CONVERSION_VIA_RGB(CIEXYZ,xyz,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_VIA_RGB(CIEXYZ,xyz,UTF_RGBA,utf_rgba)
        ...
        )
{
    ...
    for ( int i = 0; i < ARRSS_SIZE(*sr); i++ )
    {
        ARRSSPECTRUM_ARRAY_I(*sr,i) =
            + ARUT_RGB_R(rgb) * RGB_R_SAMPLES[i]
            + ARUT_RGB_G(rgb) * RGB_G_SAMPLES[i]
            + ARUT_RGB_B(rgb) * RGB_B_SAMPLES[i];
    }
}
...
void utf_rgb_to_rss_new(
        const ART_GV        * art_gv,
        const ArUTF_RGB     * rgb0,
              ArRSSpectrum  * sr
        )
{
    ARRSS_SIZE(*sr) = 109;
    ...
    {
        ARRSSPECTRUM_ARRAY_I(*sr,i) =
            + ARUT_RGB_R(*rgb0) * RGB_R_SAMPLES[i]
            + ARUT_RGB_G(*rgb0) * RGB_G_SAMPLES[i]
            + ARUT_RGB_B(*rgb0) * RGB_B_SAMPLES[i];
...
// rgb
COLOUR_CONVERSION_VIA_RGBA(CIEXYZA,xyza,UT_RGB,ut_rgb)
COLOUR_CONVERSION_VIA_RGBA(CIEXYZA,xyza,UTF_RGB,utf_rgb)
...
{
    CC_START_DEBUGPRINTF( xyza_to_xyz )
    *xyz = ARCIEXYZ(ARCIEXYZA_X(*xyza), ARCIEXYZA_Y(*xyza), ARCIEXYZA_Z(*xyza));
    CC_END_DEBUGPRINTF( xyza_to_xyz )
}

COLOUR_CONVERSION_VIA_RGBA(CIEXYZA,xyza,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_VIA_RGBA(CIEXYZA,xyza,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_BY_MACRO(RGB,RGB,rgb,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGB,RGB,rgb,UTF_RGB,UTF_RGB,utf_rgb)
...
COLOUR_CONVERSION_BY_MACRO(RGB,RGB,rgb,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGB,RGB,rgb,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,Grey,g)
COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,GreyAlpha,ga)
COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,Grey8,g8)
COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,Grey16,g16)
COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,GreyAlpha16,ga16)
COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,GreyAlpha32,ga32)

COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,CIEXYZ,xyz)
COLOUR_CONVERSION_VIA_RGB(UT_RGB,ut_rgb,CIEXYZA,xyza)

COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGB,RGB,rgb)
DUMMY_COLOUR_CONVERSION_BY_COPYING(UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGBA,RGBA,rgba)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,UTF_RGBA,UTF_RGBA,utf_rgba)

COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGB24,RGB24,rgb24)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGBA32,RGBA32,rgba32)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGB48,RGB48,rgb48)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGBA64,RGBA64,rgba64)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGB96,RGB96,rgb96)
COLOUR_CONVERSION_BY_MACRO(UT_RGB,UT_RGB,ut_rgb,RGBA128,RGBA128,rgba128)

COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UT_RGB,ut_rgb,8)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UT_RGB,ut_rgb,11)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UT_RGB,ut_rgb,18)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UT_RGB,ut_rgb,46)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UT_RGB,ut_rgb,500)

COLOUR_CONVERSION_VIA_RGB_NEW(UT_RGB,ut_rgb,RSSpectrum,rss)
COLOUR_CONVERSION_VIA_RGB_NEW(UT_RGB,ut_rgb,PSSpectrum,pss)


// =====   ArUTF_RGB   =======================================================


COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,Grey,g)
COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,GreyAlpha,ga)
COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,Grey8,g8)
COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,Grey16,g16)
COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,GreyAlpha16,ga16)
COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,GreyAlpha32,ga32)

COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,CIEXYZ,xyz)
COLOUR_CONVERSION_VIA_RGB(UTF_RGB,utf_rgb,CIEXYZA,xyza)

COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGB,RGB,rgb)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,UT_RGB,UT_RGB,ut_rgb)
DUMMY_COLOUR_CONVERSION_BY_COPYING(UTF_RGB,utf_rgb)

COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGBA,RGBA,rgba)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,UTF_RGBA,UTF_RGBA,utf_rgba)

COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGB24,RGB24,rgb24)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGBA32,RGBA32,rgba32)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGB48,RGB48,rgb48)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGBA64,RGBA64,rgba64)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGB96,RGB96,rgb96)
COLOUR_CONVERSION_BY_MACRO(UTF_RGB,UTF_RGB,utf_rgb,RGBA128,RGBA128,rgba128)

COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UTF_RGB,utf_rgb,8)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UTF_RGB,utf_rgb,11)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UTF_RGB,utf_rgb,18)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UTF_RGB,utf_rgb,46)
COLOUR_CONVERSION_COL_TO_S_IMPLEMENTATION(UTF_RGB,utf_rgb,500)

COLOUR_CONVERSION_VIA_RGB_NEW(UTF_RGB,utf_rgb,PSSpectrum,pss)
...
COLOUR_CONVERSION_BY_MACRO(RGBA,RGBA,rgba,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGBA,RGBA,rgba,UTF_RGB,UTF_RGB,utf_rgb)

DUMMY_COLOUR_CONVERSION_BY_COPYING(RGBA,rgba)
COLOUR_CONVERSION_BY_MACRO(RGBA,RGBA,rgba,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGBA,RGBA,rgba,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Grey,g)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,GreyAlpha,ga)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Grey8,g8)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Grey16,g16)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,GreyAlpha16,ga16)

COLOUR_CONVERSION_VIA_RGB(UT_RGBA,ut_rgba,CIEXYZ,xyz)
COLOUR_CONVERSION_VIA_RGB(UT_RGBA,ut_rgba,CIEXYZA,xyza)

COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGB,RGB,rgb)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGBA,RGBA,rgba)
DUMMY_COLOUR_CONVERSION_BY_COPYING(UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,UTF_RGBA,UTF_RGBA,utf_rgba)

COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGB24,RGB24,rgb24)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGBA32,RGBA32,rgba32)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGB48,RGB48,rgb48)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGBA64,RGBA64,rgba64)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGB96,RGB96,rgb96)
COLOUR_CONVERSION_BY_MACRO(UT_RGBA,UT_RGBA,ut_rgba,RGBA128,RGBA128,rgba128)

COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Spectrum8,s8)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Spectrum11,s11)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Spectrum18,s18)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Spectrum46,s46)
COLOUR_CONVERSION_VIA_RGBA(UT_RGBA,ut_rgba,Spectrum500,s500)

COLOUR_CONVERSION_VIA_RGBA_NEW(UT_RGBA,ut_rgba,PSSpectrum,pss)


// =====   ArUTF_RGBA   ======================================================


COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Grey,g)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,GreyAlpha,ga)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Grey8,g8)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Grey16,g16)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,GreyAlpha16,ga16)

// xyz
// xyza

COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGB,RGB,rgb)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGBA,RGBA,rgba)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,UT_RGBA,UT_RGBA,ut_rgba)
DUMMY_COLOUR_CONVERSION_BY_COPYING(UTF_RGBA,utf_rgba)

COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGB24,RGB24,rgb24)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGBA32,RGBA32,rgba32)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGB48,RGB48,rgb48)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGBA64,RGBA64,rgba64)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGB96,RGB96,rgb96)
COLOUR_CONVERSION_BY_MACRO(UTF_RGBA,UTF_RGBA,utf_rgba,RGBA128,RGBA128,rgba128)

COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Spectrum8,s8)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Spectrum11,s11)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Spectrum18,s18)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Spectrum46,s46)
COLOUR_CONVERSION_VIA_RGBA(UTF_RGBA,utf_rgba,Spectrum500,s500)

COLOUR_CONVERSION_VIA_RGBA_NEW(UTF_RGBA,utf_rgba,PSSpectrum,pss)
...
COLOUR_CONVERSION_RGBXX_TO_RGB(24,,)
COLOUR_CONVERSION_BY_MACRO(RGB24,RGB24,rgb24,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGB24,RGB24,rgb24,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_RGBXX_TO_RGBA(24,,)
COLOUR_CONVERSION_BY_MACRO(RGB24,RGB24,rgb24,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGB24,RGB24,rgb24,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_RGBXX_TO_RGB(32,a,A)
COLOUR_CONVERSION_BY_MACRO(RGBA32,RGBA32,rgba32,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGBA32,RGBA32,rgba32,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_RGBXX_TO_RGBA(32,a,A)
COLOUR_CONVERSION_BY_MACRO(RGBA32,RGBA32,rgba32,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGBA32,RGBA32,rgba32,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_RGBXX_TO_RGB(48,,)
COLOUR_CONVERSION_BY_MACRO(RGB48,RGB48,rgb48,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGB48,RGB48,rgb48,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_RGBXX_TO_RGBA(48,,)
COLOUR_CONVERSION_BY_MACRO(RGB48,RGB48,rgb48,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGB48,RGB48,rgb48,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_RGBXX_TO_RGB(64,a,A)
COLOUR_CONVERSION_BY_MACRO(RGBA64,RGBA64,rgba64,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGBA64,RGBA64,rgba64,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_RGBXX_TO_RGBA(64,a,A)
COLOUR_CONVERSION_BY_MACRO(RGBA64,RGBA64,rgba64,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGBA64,RGBA64,rgba64,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_RGBXX_TO_RGB(96,,)
COLOUR_CONVERSION_BY_MACRO(RGB96,RGB96,rgb96,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGB96,RGB96,rgb96,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_RGBXX_TO_RGBA(96,,)
COLOUR_CONVERSION_BY_MACRO(RGB96,RGB96,rgb96,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGB96,RGB96,rgb96,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_RGBXX_TO_RGB(128,a,A)
COLOUR_CONVERSION_BY_MACRO(RGBA128,RGBA128,rgba128,UT_RGB,UT_RGB,ut_rgb)
COLOUR_CONVERSION_BY_MACRO(RGBA128,RGBA128,rgba128,UTF_RGB,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_RGBXX_TO_RGBA(128,a,A)
COLOUR_CONVERSION_BY_MACRO(RGBA128,RGBA128,rgba128,UT_RGBA,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_BY_MACRO(RGBA128,RGBA128,rgba128,UTF_RGBA,UTF_RGBA,utf_rgba)
...
COLOUR_CONVERSION_VIA_XYZ(RSSpectrum,rss,UT_RGB,ut_rgb)
COLOUR_CONVERSION_VIA_XYZ(RSSpectrum,rss,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_VIA_XYZ(RSSpectrum,rss,RGBA,rgba)
COLOUR_CONVERSION_VIA_XYZ(RSSpectrum,rss,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_VIA_XYZ(RSSpectrum,rss,UTF_RGBA,utf_rgba)
        ...
        )
{
    ...
    ARCIEXYZ_S(*target) = ARCSR_CIEXYZ;
...
COLOUR_CONVERSION_VIA_XYZ(PSSpectrum,pss,UT_RGB,ut_rgb)
COLOUR_CONVERSION_VIA_XYZ(PSSpectrum,pss,UTF_RGB,utf_rgb)

COLOUR_CONVERSION_VIA_XYZ(PSSpectrum,pss,RGBA,rgba)
COLOUR_CONVERSION_VIA_XYZ(PSSpectrum,pss,UT_RGBA,ut_rgba)
COLOUR_CONVERSION_VIA_XYZ(PSSpectrum,pss,UTF_RGBA,utf_rgba)
