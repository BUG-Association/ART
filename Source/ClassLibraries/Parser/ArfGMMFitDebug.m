...
#define ART_MODULE_NAME     ArfGMMFitDebug

#import "ArfGMMFitDebug.h"
#import "Arn2DGMMSpectrumDebugTab.h"


static const char * arfgmmfitdebug_magic_string =
    "";
static const char * arfgmmfitdebug_short_class_name =
    "GMM";
static const char * arfgmmfitdebug_long_class_name =
    "GMM Fit";
const char * arfgmmfitdebug_exts[] =
    { "gmmd", 0 };
...
@implementation ART_MODULE_NAME

ARPFILE_DEFAULT_IMPLEMENTATION( ART_MODULE_NAME, arfiletypecapabilites_read )
ARPPARSER_AUXLIARY_NODE_DEFAULT_IMPLEMENTATION

+ (const char **) extensions
{
    return arfgmmfitdebug_exts;
}

+ (const char*) magicString
{
    return arfgmmfitdebug_magic_string;
}

- (const char*) shortClassName
{
    return arfgmmfitdebug_short_class_name;
}

- (const char*) longClassName
{
    return arfgmmfitdebug_long_class_name;
}
        ...
        : (ArList *) externals
{
    ...
    if (pFile != NULL) {
        ...
        Arn2DGMMSpectrumDebugTab * newSpectrum =
            [ ALLOC_INIT_OBJECT(Arn2DGMMSpectrumDebugTab)
                : n_gaussians
                : means
                : covariances
                : weights
